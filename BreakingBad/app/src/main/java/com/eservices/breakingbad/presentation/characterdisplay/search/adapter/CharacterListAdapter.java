...
public class CharacterListAdapter extends RecyclerView.Adapter<CharacterListAdapter.CharacterViewHolder> {
    ...
    public static class CharacterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener  {
        ...
        public CharacterViewHolder(View v, final CharacterActionInterface characterActionInterface) {
            ...
            nameTextView = v.findViewById(R.id.character_info_name_textview);
            nicknameTextView = v.findViewById(R.id.character_info_nickname_textview);
            iconImageView = v.findViewById(R.id.character_info_photo_imageview);
            eyeImageView = v.findViewById(R.id.character_info_already_seen_imageview);
        }
    ...
    public CharacterListAdapter(CharacterActionInterface characterActionInterface) {
    ...
    public CharacterViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_character_for_listview, parent, false);
